...
export const FilterTodos: React.FC<Props> = ({
  amountActive, hascompletTodos, selected, setSelected, clearCompleted,
}) => {
  return (
    <footer className="todoapp__footer">
      <span className="todo-count">
        { amountActive === 1 || amountActive === 0 ? `${amountActive} item left` : `${amountActive} items left`}
      </span>
      ...
      <button
        ...
        style={{ visibility: hascompletTodos ? 'visible' : 'hidden' }}
        type="button"
